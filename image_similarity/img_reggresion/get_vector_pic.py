...
path_gambar = '/Users/thomas/Documents/UI/LF/img_regression/gambar/'
pria = path_gambar + 'pria'
wanita = path_gambar + 'wanita'
...
print("========================================")
data = {'pria': vector_group_pria, 'wanita': vector_group_wanita}
df = pd.DataFrame(data=data)
df.to_csv('pria_wanita_vector.csv', index=False)
